...
const createJwtToken = (admin) => {
    return jsonwebtoken_1.default.sign({ id: admin.id }, process.env.JWT_SECRET_KEY, {
...
exports.default = { createJwtToken: exports.createJwtToken, verifyToken: exports.verifyToken };
